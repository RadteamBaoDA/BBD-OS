...
- [~] Phase 3: search and embeddings (P03-T1 and P03-T2 production code/build/review complete; P03-T3 code/build complete with independent review pending; behavior tests deferred).
